<?php
	...
	if(isset($_REQUEST['submit']))
	{
		...
		$update=mysqli_query($con,"UPDATE anniversary SET img='$fnm',nm='$nm',price='$pr' where id='$id'");
		if($update>0)
		{
...
<div class="grid_3 grid_4">
				<div class="tab-content">
					...
					<input type="submit" name="submit" class="btn" value="UPDATE"> <input type="button" value="DISPLAY" class="btn my" onClick="javascript:location.href='anni_disp.php'" />
					</div>
					</form>
					</div>
				</div>
