...
<div class="codes">
<div class="container">
<h3 class='w3ls-hdg' align="center">EDIT OTHER EVENTS</h3> 
<div class="grid_3 grid_4">
				<div class="tab-content">
					...
					<input type="submit" name="submit" class="btn" value="SEND"> <input type="button" value="DISPLAY" class="btn my" onClick="javascript:location.href='other_disp.php'"/>
					</div>
					</form>
					</div>
				</div>
